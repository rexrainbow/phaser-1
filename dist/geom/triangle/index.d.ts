...
export { BuildEquilateralTriangle, BuildRightTriangle, CenterTriangleOn, CloneTriangle, CopyTriangleFrom, DecomposeTriangle, GetTriangleArea, GetTriangleCentroid, GetTriangleCircumCenter, GetTriangleCircumCircle, GetTriangleEdges, GetTriangleInCenter, GetTrianglePerimeter, GetTrianglePoint, GetTrianglePoints, GetTriangleRandomPoint, RotateTriangle, RotateTriangleAround, RotateTriangleAroundPoint, TranslateTriangle, Triangle, TriangleContains, TriangleContainsPoint, TriangleContainsPoints, TriangleEquals };
