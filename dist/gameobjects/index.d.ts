...
export { AddChild, AddChildAt, AddChildren, AddChildrenAt, AddPosition, AddRotation, AddScale, AddSkew, AnimatedSprite, BringChildToTop, Container, CountMatchingChildren, DestroyChildren, GameObject, GetChildAt, GetChildIndex, GetChildren, GetFirstChild, GetLastChild, GetRandomChild, MoveChildDown, MoveChildTo, MoveChildUp, MoveToPosition, RemoveChild, RemoveChildAt, RemoveChildren, RemoveChildrenAt, RemoveChildrenBetween, ReparentChildren, RotateChildrenLeft, RotateChildrenRight, SendChildToBack, SetBounds, SetName, SetOrigin, SetParent, SetPosition, SetRotation, SetScale, SetSize, SetSkew, SetType, SetVisible, SetWorld, ShuffleChildren, Sprite, SwapChildren, Text };
