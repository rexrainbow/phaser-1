...
export { AddChild3D, AddChild3DAt, AddChildren3D, AddChildren3DAt, ConsoleTreeChildren3D, CountMatchingChildren3D, DepthFirstSearch3D, DepthFirstSearchRecursive3D, DepthFirstSearchRecursiveNested3D, DestroyChildren3D, FindChild3DByName, FindChildren3DByName, GetAllChildren3D, GetChild3DAt, GetChild3DIndex, GetChildren3D, GetFirstChild3D, GetLastChild3D, GetParents3D, GetRandomChild3D, MoveChild3DTo, RemoveChild3D, RemoveChild3DAt, RemoveChildren3D, RemoveChildren3DAt, RemoveChildren3DBetween, ReparentChildren3D, ReplaceChild3D, SetChildren3DValue, SetParent3D, SetWorld3D, SwapChildren3D };
