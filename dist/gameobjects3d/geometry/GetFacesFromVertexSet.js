...
export function GetFacesFromVertexSet(data) {
  ...
  for (let i = 0; i < indices.length; i += 3) {
    ...
    const f = new FaceUVNormalTexture2({x: v1[0], y: v1[1], z: v1[2]}, {x: v2[0], y: v2[1], z: v2[2]}, {x: v3[0], y: v3[1], z: v3[2]}, {x: n1[0], y: n1[1], z: n1[2]}, {x: n2[0], y: n2[1], z: n2[2]}, {x: n3[0], y: n3[1], z: n3[2]}, {x: uv1[0], y: uv1[1]}, {x: uv2[0], y: uv2[1]}, {x: uv3[0], y: uv3[1]}, 1);
    faces.push(f);
  }
  return faces;
}
