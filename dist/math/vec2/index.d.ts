...
export { GetChebyshevDistance, GetDistanceFromSegment, GetVec2ManhattanDistance, GetVec2ManhattanLength, GetVec2Length, GetVec2LengthSquared, Vec2, Vec2Abs, Vec2Add, Vec2AddScalar, GetVec2Angle, GetVec2AngleY, Vec2Bezier, Vec2Callback, Vec2CatmullRom, Vec2Ceil, Vec2Center, Vec2Clamp, Vec2ClampScalar, Vec2Clone, Vec2CopyFrom, Vec2Cross, GetVec2Distance, GetVec2DistancePower, GetVec2DistanceSquared, Vec2Divide, Vec2DivideScalar, Vec2Dot, Vec2Equals, Vec2Floor, Vec2Fract, Vec2FromGridIndex, Vec2FromTransform, Vec2FuzzyEquals, Vec2Hermite, Vec2Inverse, Vec2Lerp, Vec2Max, Vec2Min, Vec2Multiply, Vec2MultiplyByFloats, Vec2Negate, Vec2Normalize, Vec2One, Vec2PerpDot, Vec2Random, Vec2Rotate, Vec2Round, Vec2RoundToZero, Vec2Scale, Vec2ScaleAndAdd, Vec2SetLength, Vec2Subtract, Vec2SubtractScalar, Vec2Transform, Vec2TransformMat2d, Vec2TransformMat4, Vec2Zero };
